...
python -m pybadges --left-text='English' --right-text='5 key terms' --right-color='#1E90FF' > language-en.svg
python -m pybadges --left-text='Português' --right-text='4 palavras-chaves' --right-color='#1E90FF' > language-pt.svg