...
python -m pybadges --left-text='English' --right-text='6 Tags' --right-color='#1E90FF' > language-en.svg
python -m pybadges --left-text='Español' --right-text='2 Etiquetas' --right-color='#1E90FF' > language-es.svg
